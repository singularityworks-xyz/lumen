...
Instead of forcing everything into a linear backlog, Lumen lets you place
boards, tasks, notes, and structures directly on an infinite canvas. You can
build boards inside boards, connect related work visually, keep local state
durable offline, and add shared workspaces only when collaboration is actually
needed.
