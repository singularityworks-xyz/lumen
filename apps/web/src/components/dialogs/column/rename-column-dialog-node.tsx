...
export interface RenameColumnDialogNodeData {
  columnId: string;
  dialogId: string;
  [key: string]: unknown;
}
...
export const RenameColumnDialogNodeComponent =
  memo<RenameColumnDialogNodeProps>(({ data, selected }) => {
    ...
    const handleSubmit = useCallback(
      ...
      [columnDialog, updateColumn, closeColumnDialog, data.dialogId]
    );
    ...
    const handleDescriptionChange = useCallback(
      (value: string) => {
        updateColumnDialogDescriptionValue(data.dialogId, value);
      },
      [updateColumnDialogDescriptionValue, data.dialogId]
    );
