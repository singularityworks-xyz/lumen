      ...
      <>
        ...
        >
          ...
          <div className="p-5">
            <div className="mb-3 flex items-start gap-3 rounded-lg border border-amber-500/20 bg-amber-500/5 p-3">
              ...
              <p className="text-amber-700 text-sm dark:text-amber-400">
                This action will remove all boards, columns, and tasks from this
                workspace. The workspace itself will remain.
              </p>
            </div>
          ...
          <div className="flex justify-end gap-2 border-t bg-muted/30 px-5 py-3 shadow-[inset_0_1px_3px_rgba(0,0,0,0.1)] dark:shadow-[inset_0_2px_6px_rgba(255,255,255,0.08),inset_0_-1px_3px_rgba(0,0,0,0.4)]">
            ...
            <Button
              className="h-8 rounded-md bg-amber-500/90 text-white text-xs shadow-[0_2px_4px_rgba(0,0,0,0.15),inset_0_1px_0_rgba(255,255,255,0.2)] hover:bg-amber-500 dark:shadow-[0_2px_4px_rgba(0,0,0,0.3),inset_0_1px_2px_rgba(255,255,255,0.15),inset_0_-1px_1px_rgba(0,0,0,0.4)]"
              onClick={() => {
                onConfirm();
                onClose();
              }}
